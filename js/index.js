...
class Particle {
  constructor(app, container, options) {
    ...
    this.progress = 0; //this.texture = new PIXI.extras.AnimatedSprite(media);
    ...
    this.texture.anchor.set(0.5); //this.texture.animationSpeed = 0.5;
    //this.texture.play();
  ...
  move() {
    ...
    this.progress = this.progress + this.speed; //Destroy
